...
class _AppointmentScreenState extends State<AppointmentScreen> {
  ...
  final TextEditingController _nameController = TextEditingController(text: 'Vivek Addagatla');
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              ...
              child: const Text('Confirm', style: TextStyle(color: Colors.indigo, fontWeight: FontWeight.bold)),
            ),
          ],
        );
      },
